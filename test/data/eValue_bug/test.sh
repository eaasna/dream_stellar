...
$MY_STELLAR -e $errRate -l $minLen --suppress-runtime-printing -o my_stellar_chr3.gff chr3.fasta $query_file > my_stellar_chr3.stdout 

$STELLAR -e $errRate -l $minLen --suppress-runtime-printing -o stellar_chr3.gff chr3.fasta $query_file > stellar_chr3.stdout 
